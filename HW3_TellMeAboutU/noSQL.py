...
def create():
    if request.method == 'POST':
        ...
        new_doc = {'nickname': nickname, 'zodiac': zodiac, 'gender': gender, 'song': song , 'created_at': timestamp}
...
def search():
    ...
    query = {"$or": [{field: regex_query} for field in ["nickname", "zodiac", "created_at", "gender", "song"]]}
